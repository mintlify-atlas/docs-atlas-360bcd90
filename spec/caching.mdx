...
| Language-specific | `https://github.com/tldr-pages/tldr/releases/latest/download/tldr-pages.{{language-code}}.zip` | Pages for a single language |

Language-specific archive examples:

```text
tldr-pages.fr.zip   — French
tldr-pages.zh.zip   — Chinese
tldr-pages.pt_BR.zip — Portuguese (Brazil)
tldr-pages.it.zip   — Italian
```
